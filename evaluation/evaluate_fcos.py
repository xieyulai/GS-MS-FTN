...
if __name__=='__main__':
    ...
    parser.add_argument('-s', '--submission', type=str,  default='../results/0815142747_audio_video_text/captioning_results_learned_props_e17_1634805201.3798664.json',
                        help='sample submission file for ActivityNet Captions Challenge.')
    parser.add_argument('-r', '--references', type=str, nargs='+', default=['../data/val_1_no_missings_subs.json','../data/val_2_no_missings_subs.json'],
