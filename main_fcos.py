...
if __name__ == "__main__":
    ...
    parser.add_argument('--global_text_features_path', type=str, default='./data/global_text_npy/')
    ...
    parser.add_argument('--cen_coeff', type=float, default=0.1,help='centerness coeff in loss')
